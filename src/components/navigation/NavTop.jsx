                        ...
                        <div className="bg-black-80 pb5 pb6-m pb7-l">
                            <nav className={`dt w-100 mw8 center`} >
                                ...
                                <div className="dtc v-mid tl pa3">
                                    <p className="f6 fw4 hover-white no-underline white-70 dib pv2 ph3">
                                        Home</p>
                                    <p className="f6 fw4 hover-white no-underline white-70 dib pv2 ph3">
                                        About</p>
                                </div>
                            ...
                            <div className="tc-l mt4 mt5-m mt6-l ph3">
                                <h1 className="f2 f1-l fw2 white-90 mb0 lh-title">"Education is the passport to the future, for tomorrow belongs to those who prepare for it today."</h1>
